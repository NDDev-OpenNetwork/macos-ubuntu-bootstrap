...
bootstraps Homebrew from its notarized `6.0.9` package. At contract `2.5.1` the
...
ZCode is not installed by this repository, and since contract `2.5.1` it is not
